...
<div class="wrap intro">
  <p>
    <b>Codekart</b> 是一套给 Node.js 开发者使用的应用程序开发框架和工具包。
...
<div class="wrap info">
  ...
  <p class="li">* │作者：杨捷</p>
  <p class="li">* │邮箱：yangjie@jojoin.com</p>
  <p class="li">* │QQ  ：446342398</p>
  <p class="li">* │Github  ：<a href="http://github.com/yangjiePro/" target="_blank">https://github.com/yangjiePro/</a></p>
  <br>
</div>
<br>
<br>
